...
assert(ZONE_MIX.urban.hoodrat === 0.26 && ZONE_MIX.urban.redneck === 0.03 && ZONE_MIX.urban.prostitute === 0.22, "Urban zone: 26% Hoodrat / 3% Redneck / 22% prostitute (rest nightlife crowd)");
